<template>
  <q-layout view="lHh LpR fFf">
    <q-header elevated class="bg-blue-grey-7 text-white" style="font-family:Microsoft JhengHei;">
      <q-toolbar>
    ...
    >
      ...
      <q-icon class="q-mt-none q-mb-xs q-ml-md" color="#cccccc" name="help" size="26px">
        <q-tooltip
          ...
          :offset="[10, 10]"
        >
          <span>您可以搭配我們的分析步驟，把喜愛的景點飯店加入排程</span>
        </q-tooltip>
      </q-icon>
      <q-breadcrumbs-el
        label="天數"
        ...
        <q-card>
          ...
          <q-tab-panels v-model="tab" animated>
              ...
              <div v-if="step2Tab == 'site'">
                ...
                <div class="q-pa-md q-mt-none">
                  <div class="q-pa-md doc-container text-black bg-grey-3">
                    <div class="row text-h4" style="font-family: Microsoft JhengHei;">
                      <b>自選景點</b>
            ...
            <q-tab-panel name="movies">
              ...
              <div class="q-pa-md">
                <div
                  class="q-pa-md doc-container text-black bg-grey-3"
                  style="font-family:Microsoft JhengHei;"
                >
                  <div class="row q-py-md justify-center text-h4">
                    <b>路徑規畫分析</b>
            ...
            <q-tab-panel name="aa">
              <!-- 網頁 title-->
              <div class="gt-xs" style="font-size:28px;font-family:Microsoft JhengHei;">
                <b>GoogleMap找出最短路線</b>
                <q-icon color="red" name="report_problem" size="20px" />
                <span class="text-subtitle2" style="color:red">起點與終點為固定順序</span>
              </div>
              <!-- 手機 title-->
              <div class="lt-sm" style="font-size:28px;font-family:Microsoft JhengHei;">
                <b>GoogleMap找出最短路線</b>
                <div class="row">
                  <q-icon color="red" name="report_problem" size="20px" />
                  <span class="text-subtitle2" style="color:red">起點與終點為固定順序</span>
