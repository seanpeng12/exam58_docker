      ...
      <div class="gt-xs q-pa-lg q-ma-sm column items-center text-black bg-grey-3" style="height: 250px;">
        <div class="col">
          <div class="text-center img_background">
            <div>
              <p style="font-size: 28px;font-family: Microsoft JhengHei;">旅館優缺點分析</p>
            </div>
          </div>
        </div>
        ...
        <div class="col">
          <div class="text-center img_background">
            <div>
              <b class="text" style="font-size: 27px;font-family: Microsoft JhengHei;">請先選擇區域(城市)</b>
            </div>
          </div>
        </div>
    ...
    <div class="q-pa-md">
      <div class="row">
        <div class="col q-pa-xs">
          <!-- iframe col div 優點 -->
          <div class="gt-xs col">
            <div class=" bg-cyan-10 text-center img_background">
              <div>
                <p class="text-white" style="font-size: 30px;font-family: Microsoft JhengHei;">優點</p>
              </div>
            </div>
            <q-page>
              <iframe
        ...
        <div class="col q-pa-xs">
          <!-- iframe col div -->
          <div class="gt-xs col">
            <div class="bg-red-4 text-center img_background">
              <div>
                <p class="text-white" style="font-size: 30px;font-family: Microsoft JhengHei;">缺點</p>
              </div>
            </div>
            <q-page>
              <iframe
