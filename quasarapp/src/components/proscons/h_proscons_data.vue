          ...
          <div>
            ...
            <div>
              ...
              >
                <q-chip
                  size="md"
                  v-for="(a, index) in prosData.data"
                  :key="a.id"
                >
                  <!-- 前三 -->
                  <div v-if="index == 0">
                  ...
                  <div
                    v-if="
                      a.degree >= 30 && index != 0 && index != 1 && index != 2
                    "
                  >
                    <q-avatar
                      icon="thumb_up_alt"
                  ...
                  <div
                    v-else-if="
                      a.degree === 1 && index != 0 && index != 1 && index != 2
                    "
                  >
                    <q-avatar
                      icon="thumb_up_alt"
          ...
          <div>
            ...
            <div>
              ...
              >
                <q-chip
                  size="md"
                  v-for="(a, index) in consData.data"
                  :key="a.id"
                >
                  <!-- 前三 -->
                  <div v-if="index == 0">
