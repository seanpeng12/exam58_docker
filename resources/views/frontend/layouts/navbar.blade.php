<nav class="probootstrap-nav">
          ...
          <ul>
            ...
            <li class="probootstrap-animate active" data-animate-effect="fadeInLeft"><a href="{{ route('home') }}">Home</a></li>
            ...
            <li class="probootstrap-animate" data-animate-effect="fadeInLeft"><a href="{{ route('waypoints') }}">Waypoints</a></li>
